class ChatWebsocket
{
    siteAddr = "http://messenger.loc/src/";
    ...
    chatType = null;
    openChatId = -1;
// Конструктор позволяет произвести начальную инициализацию, 
// которая должна быть выполнена до того, как остальные методы будут вызваны.
