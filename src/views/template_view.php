...
<head>
    ...
    <link rel="stylesheet" href="http://messenger.loc/src/css/reset_styles.css">
    <link rel="stylesheet" href="http://messenger.loc/src/css/template.css">
    <?php if (!empty($content_css)) : ?>
        <link rel="stylesheet" href="http://messenger.loc/src/css/<?= $content_css ?>">
    <?php endif; ?>
</head>
<body>
...
<?php if (!empty($content_js)) : ?>
    <script type='text/javascript' src="http://messenger.loc/src/js/<?= $content_js ?>"></script>
<?php endif; ?>
</body>
</html>
