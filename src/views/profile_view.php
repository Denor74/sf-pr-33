    ...
    <div class='profile-container'>
        <div class='profile-img-block'>
            ...
            if (is_null($data['user_photo']) || $data['user_photo'] == 'ava_profile.png') {
                $photo = 'http://messenger.loc/src/images/ava_profile.png';
            } else {
                $photo = 'http://messenger.loc/src/data/profile_photos//' . $data['user_photo'];
            }
            ?>
...
<script type='text/javascript' src="http://messenger.loc/src/js/validation.js"></script>
