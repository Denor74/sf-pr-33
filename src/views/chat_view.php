    ...
    <div class='container chat-container d-flex p-0 bg-c4c4c4 font-roboto'>
            ...
            <div class='h-50 border-bottom border-dark overflow-auto'>
                ...
                <div class='btn-resend-block' id='btn-resend-block'>
                    <button class='btn-resend' id='btn-resend' disabled>
                        <div class='btn-resend__img-block'><img src="src/images/resend.png" class='img' title='Переслать'></div>
                        <span class='btn-resend__name'>Переслать</span>
                    </button>
                    <button class='btn-resend' id='btn-resend-reset'>
                        <div class='btn-resend__img-block'><img src="src/images/cancel.png" class='img' title='Отменить'></div>
        ...
        <div class='messages-container border-start border-end border-dark d-flex flex-column pe-2'>
            ...
            <div class='input-group d-flex justify-content-between pb-2'>
                ...
                <button type="submit" class='send-btn-img' title='Отправить' id="send-msg-btn" disabled><img src="src/images/sendbtn.png"></button>
            </div>
        </div>
        ...
        <div class='options-container pt-2'>
            <div class='option'>
                <a href="/profile" class='option-link'>
                    <div class='option-img-block'><img src="src/images/profile.png" class='img' title='Профиль'>
                    </div>
            ...
            <div class='option'>
                <div class='option-link'>
                    <div class='option-img-block'><img src="src/images/settings.png" class='img' title='Настройки'>
                    </div>
            ...
            <div class='option'>
                <div class='option-link' id='create-group-option'>
                    <div class='option-img-block'><img src="src/images/group.png" class='img'
            ...
            <div class='option'>
                <a href="/Main?logout=true" class='option-link'>
                    <div class='option-img-block'><img src="src/images/exit.png" class='img' title='Выход'></div>
...
<script type='text/javascript' src="http://messenger.loc/src/js/ChatWebsocket.js"></script>

<script type='text/javascript' src="http://messenger.loc/src/js/contex-menu/ContexMenu.js"></script>
<script type='text/javascript' src="http://messenger.loc/src/js/contex-menu/MessageContexMenu.js"></script>
<script type='text/javascript' src="http://messenger.loc/src/js/contex-menu/ContactContexMenu.js"></script>

<script type='text/javascript' src="http://messenger.loc/src/js/chat/TemplateContainer.js"></script>
<script type='text/javascript' src="http://messenger.loc/src/js/chat/MessageContainer.js"></script>
<script type='text/javascript' src="http://messenger.loc/src/js/chat/ContactContainer.js"></script>
<script type='text/javascript' src="http://messenger.loc/src/js/chat/GroupContainer.js"></script>
<script type='text/javascript' src="http://messenger.loc/src/js/chat/chat.js"></script>